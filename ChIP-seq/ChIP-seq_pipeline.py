...
def process_args():
	...
	macs2_group.add_argument('--macs2_genome', required=False, type=str, default='hs', help='MACS2 genome size (e.g. hs for human, mm for mouse)')

	rpkm_group = parser.add_argument_group('Signal track parameters')
	rpkm_group.add_argument('--genomeSize', required=False, type=int, default=2864785220, help='Genome size for RPKM calculation [2864785220 for hg19]')
